...
namespace Fazon {
	...
	bool ImGuiLayer::m_onKeyPressedEvent(KeyPressedEvent&) {
		return false;
	}

	bool ImGuiLayer::m_onKeyReleasedEvent(KeyReleasedEvent&) {
		return false;
	}

	bool ImGuiLayer::m_onWindowResizedEvent(WindowResizedEvent&) {
		return false;
	}
